...
public class Event {
     ...
     * {@code Modality#CAR} which defines the new {@code Modality}. Or {@code Null} if the {@code EventType} does not
     ...
     *            e.g. {@code Modality#CAR} which defines the new {@code Modality}. If no such information is required
     *            use
     */
    public Event(final long id, final EventType type, final long timestamp, final String value) {
        this.id = id;
        this.type = type;
     ...
     * slice {@code Measurement}s into {@code Track}s before they are resumed.
     *
     * @author Armin Schnabel
     * @version 1.0.0
     * @since 4.0.0
